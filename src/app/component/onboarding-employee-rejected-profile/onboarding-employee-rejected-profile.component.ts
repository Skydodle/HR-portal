...
@Component({
  selector: 'app-onboarding-employee-rejected-profile',
  templateUrl: './onboarding-employee-rejected-profile.component.html',
  styleUrls: ['./onboarding-employee-rejected-profile.component.css']
})
export class OnboardingEmployeeRejectedProfileComponent implements OnInit {
